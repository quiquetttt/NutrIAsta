...
export function FullBackupPanel({ onChanged }: { onChanged: () => Promise<void> }) {
  ...
  return <Card><View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8 }}><SectionTitle eyebrow="Copia local">Backup completo</SectionTitle><StatusPill label="AES-256 · formato 4" tone="good" /></View><Text selectable style={{ color: palette.muted, lineHeight: 20 }}>Incluye las 26 tablas: perfil, nutrición, entrenamientos, peso, inventario, compra, recetas, fotografías locales y procedencia de alta. No incluye el texto OCR reconocido. Puede restaurar los formatos 1, 2, 3 y 4 mediante un candidato temporal, incluso cuando la base principal ya está activa. La contraseña no se guarda ni puede recuperarse.</Text>

...
export interface NutritionSnapshot { name: string; energyKcal: number; proteinG: number; carbohydratesG: number; fatG: number | null; baseUnit: FoodBaseUnit; sourceUpdatedAt: string; }
...
export interface NutritionTotals { energyKcal: number; proteinG: number; carbohydratesG: number; fatG: number | null; }
